# Initializes TITANS who want to ROCKET with ROTATION 4
...
execute @e[type=armor_stand,tag=titanRocket,r=10,c=2] ~ ~ ~ summon vex ~ ~ ~ {Tags:["hostile","titan","titanRocketProjectileBase","titanRocketProjectileBase4","titanRocketProjectile","titanRocketProjectile4","titanRocketProjectileNew4"],Silent:1,Rotation:[180f,-45f],PersistenceRequired:1,Attributes:[{Name:generic.followRange,Base:60},{Name:generic.attackDamage,Base:0}],ActiveEffects:[{Id:14,Amplifier:0,Duration:2000000,ShowParticles:0b}],Invulnerable:1b}

# Remove Tags
scoreboard players tag @s remove titanWantsToOverheat

# Initialize Clock for Rocket Projectile
scoreboard players set @e[type=vex,tag=titanRocketProjectileNew4] clockAttack -1 

# Summon Zombie for Visual
execute @e[type=vex,tag=titanRocketProjectileNew4] ~ ~ ~ summon zombie ~ ~ ~ {Tags:["hostile","titan","titanRocketProjectile","titanRocketProjectile4","titanRocketProjectileVisual","titanRocketProjectileVisualNew"],NoAI:1,Silent:1,Rotation:[180f,-45f],PersistenceRequired:1,ArmorItems:[{},{},{},{id:golden_hoe,Damage:13,Count:1b,tag:{Unbreakable:1}}],ActiveEffects:[{Id:14,Amplifier:0,Duration:2000000,ShowParticles:0b},{Id:11,Amplifier:5,Duration:2000000,ShowParticles:0b}]}
...
scoreboard players tag @e[tag=titanRocketProjectileNew4] remove titanRocketProjectileNew4 
