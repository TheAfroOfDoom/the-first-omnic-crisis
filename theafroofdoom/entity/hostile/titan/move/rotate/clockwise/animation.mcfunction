# Dictate TITAN ROTATE CLOCKWISE module AT score_clock_min=0,score_clock=14
...
execute @s ~ ~-13 ~ execute @e[tag=titanLegMarker7,c=1] ~ ~ ~ teleport @e[tag=titanLegNextRotationClockwise,c=1] ~ ~8.355 ~
...
tp @e[tag=titanLegNextRotationClockwise,c=1] ~ ~ ~ ~6.0 ~ 
tp @s ~ ~ ~ ~3.0 ~ 
