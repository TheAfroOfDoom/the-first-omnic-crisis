# Dictate TITAN ROTATE CLOCKWISE END OF LOOP Module
...
# If ROTATION is 8, loop back around to 0 (think 0 degrees = 360 degrees)
scoreboard players set @s[score_rotation_min=8] rotation 0

# Remove titanIsRotatingClockwise tag
scoreboard players tag @s remove titanIsRotatingClockwise
...
# Self Turn-Off
function theafroofdoom:entity/hostile/titan/move/rotate/clockwise/turn_off_loop unless @e[type=armor_stand,tag=titanIsRotatingClockwise] 
